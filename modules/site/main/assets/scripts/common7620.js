...
(function() {
    ...
    const ABI = [{"constant":true,"inputs":[],"name":"contractInfo","outputs":[{"name":"_total_users","type":"uint256"},{"name":"_total_reports","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"_addr","type":"address"}],"name":"userInfo","outputs":[{"name":"id","type":"uint256"},{"name":"dob","type":"uint40"},{"name":"age","type":"uint8"},{"name":"user_details","type":"bytes32[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"accidents","outputs":[{"name":"id","type":"uint256"},{"name":"justification","type":"string"},{"name":"location","type":"string"},{"name":"pic1","type":"string"},{"name":"accident_date","type":"string"},{"name":"vehicle_no","type":"string"},{"name":"points","type":"uint256"},{"name":"reportedby","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_cp_name","type":"string"},{"name":"_cp_relation","type":"string"},{"name":"_cp_email","type":"string"},{"name":"_cp_mobile_no","type":"string"}],"name":"updatecontact","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"_addr","type":"address"}],"name":"userTotalInfo","outputs":[{"name":"id","type":"uint256"},{"name":"name","type":"string"},{"name":"points","type":"uint256"},{"name":"total_accident","type":"uint256"},{"name":"total_report","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_name","type":"string"},{"name":"_vehicle_no","type":"string"},{"name":"_mobile_no","type":"string"},{"name":"_cp_name","type":"string"},{"name":"_cp_mobile_no","type":"string"}],"name":"signup","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"owner","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"string"}],"name":"vehicles","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"accident_points","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"users","outputs":[{"name":"id","type":"uint256"},{"name":"points","type":"uint256"},{"name":"total_accidents","type":"uint256"},{"name":"total_reports","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_address1","type":"string"},{"name":"_address2","type":"string"},{"name":"_city","type":"string"},{"name":"_pincode","type":"string"},{"name":"_state","type":"string"},{"name":"_country","type":"string"}],"name":"updateaddress","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_name","type":"string"},{"name":"_mobile_no","type":"string"},{"name":"_dob","type":"uint40"},{"name":"_age","type":"uint8"},{"name":"_gender","type":"string"},{"name":"_blood_group","type":"string"},{"name":"_email","type":"string"},{"name":"_rc_book","type":"string"}],"name":"updateprofile","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_newname","type":"string"}],"name":"signup1","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"source","type":"string"}],"name":"stringToBytes32","outputs":[{"name":"result","type":"bytes32"}],"payable":false,"stateMutability":"pure","type":"function"},{"constant":true,"inputs":[{"name":"_addr","type":"address"}],"name":"userReportInfo","outputs":[{"name":"id","type":"uint256[]"},{"name":"points","type":"uint256[]"},{"name":"others","type":"bytes32[5][]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"total_users","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"addresses","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"total_accidents","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_justification","type":"string"},{"name":"_location","type":"string"},{"name":"_accident_date","type":"string"},{"name":"_vehicle_no","type":"string"}],"name":"report","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"inputs":[{"name":"_owner","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":true,"name":"reportedby","type":"address"},{"indexed":false,"name":"vehicle_no","type":"string"},{"indexed":false,"name":"accident_date","type":"string"},{"indexed":false,"name":"loc","type":"string"}],"name":"AccidentReported","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"name":"reportedby","type":"address"},{"indexed":false,"name":"vehicle_no","type":"string"},{"indexed":false,"name":"accident_date","type":"string"},{"indexed":false,"name":"loc","type":"string"},{"indexed":false,"name":"cpname","type":"string"},{"indexed":false,"name":"cpmobileno","type":"string"}],"name":"AccidentReportedWithContact","type":"event"}];
    ...
    new Vue({
       ...
       data: {
            tab: 'main',
            contract_address: 'TVLVoLEAvMwBgMG8TaAH6MSDaPuCW9BKok',
			username: '',
			vehicle_no: '',
			mobile_no: '',
			dob: 0,
